...
public class PedidoController {
	...
	public ResponseEntity<List<PedidoDTO>> traePedido(@PathVariable("cia") String cia, @PathVariable("orden") String orden)  throws Exception{
		List<PedidoDTO> lista = new ArrayList<>();
		lista = service.listapedido(cia, orden);
